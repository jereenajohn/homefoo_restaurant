...
import 'package:homefoo_restaurant/create_coupon.dart';
...
Future<void> fetchuserdetails() async {
  try {
    ...
    final response = await http.get(Uri.parse('https://store-firewire-anticipated-actual.trycloudflare.com/HOMFOO-restaurant/restaurant-details/$userId/'));
