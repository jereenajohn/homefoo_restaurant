  ...
  void Rlogin() async {
    ...
    try {
      var response = await http.post(
        Uri.parse("https://go-salon-cartoon-journals.trycloudflare.com/HOMFOO-restaurant/login/"),
        body: {
          'email': email.text,
            ...
            Image.asset(
              ...
              fit: BoxFit.cover,
               ...
               Row(
                              ...
                              children: [
                                Text("Welcom Back !",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                              ],
                  ),
